...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BaC0PEo6.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CjvdeqdX.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DBKwJhXc.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B3eobBRp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DN3P2Nz3.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, __nuxt_component_0$2 as d, entry$1 as default, asyncDataDefaults as e, createError as f, useAppConfig as g, __nuxt_component_0 as h, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
